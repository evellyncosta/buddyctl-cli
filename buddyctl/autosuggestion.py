...
class AutoSuggestionHandler:
    ...
    def get_suggestions(self, text: str, cursor_pos: int, max_results: int = 10) -> List[Dict[str, Any]]:
    ...
    def apply_suggestion(self, text: str, cursor_pos: int, suggestion: Dict[str, Any]) -> Tuple[str, int]:
    ...
    def load_referenced_files(self, text: str, max_file_size: int = 1024 * 1024) -> Dict[str, Optional[str]]:
